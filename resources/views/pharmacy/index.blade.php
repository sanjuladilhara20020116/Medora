...
<div id="pharmacyIndexPage" class="mx-auto max-w-7xl">
    ...
    <section class="grid gap-4 sm:grid-cols-3"><article class="rounded-2xl border border-red-200 bg-red-50 p-5"><p class="text-sm font-semibold text-red-700">Expired Batches</p><p id="expiredStockCount" class="mt-2 text-3xl font-bold text-red-900">—</p></article><article class="rounded-2xl border border-amber-200 bg-amber-50 p-5"><p class="text-sm font-semibold text-amber-700">Expiring in 30 Days</p><p id="expiringStockCount" class="mt-2 text-3xl font-bold text-amber-900">—</p></article><article class="rounded-2xl border border-cyan-200 bg-cyan-50 p-5"><p class="text-sm font-semibold text-cyan-700">Low Stock Medicines</p><p id="lowStockCount" class="mt-2 text-3xl font-bold text-cyan-900">—</p></article></section>
    <section class="mt-6 grid gap-6 xl:grid-cols-3">
        ...
        <article class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm"><h3 class="font-bold text-slate-950">{{ $title }}</h3><div id="{{ $id }}" class="mt-5 space-y-3 text-sm text-slate-500">Loading...</div></article>
        @endforeach
    </section>
</div>
